...
} elseif ($_instance->childHasBeenRendered('Egy6OLJ')) {
    $componentId = $_instance->getRenderedChildComponentId('Egy6OLJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('Egy6OLJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Egy6OLJ');
} else {
    $response = \Livewire\Livewire::mount('like-post', ['post' => $post]);
    $html = $response->html();
    $_instance->logRenderedChild('Egy6OLJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/blairi/Documents/Laravel/devstagram/resources/views/posts/show.blade.php ENDPATH**/ ?>