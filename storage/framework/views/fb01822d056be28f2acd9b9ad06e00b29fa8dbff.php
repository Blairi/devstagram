...
<body class="bg-gray-100 my-[120px]">
    ...
    <header class="p-5 border-b bg-white shadow fixed top-0 left-0 w-full z-10">
        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <a href="<?php echo e(route('home')); ?>" class="text-2xl md:text-3xl font-black">
                Devstagram
            </a>
...
<?php /**PATH /home/blairi/development/Laravel/devstagram/resources/views/layouts/app.blade.php ENDPATH**/ ?>